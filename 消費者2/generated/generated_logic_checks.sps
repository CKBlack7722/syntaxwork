...
compute p384="vB7=7，vB7D應<=vA7".
end if.

* logic check limit vB7D.
do if (vB7D=7) & vB7D>vA7.
compute m385=concat("vB7D=",string(vB7D,n10),",vA7=",string(vA7,n10)).
compute p385="vB7D=7，vB7D應<=vA7".
end if.

* logic check limit vB7D.
do if (vB7DR=7) & vB7D>vA7R.
compute m386=concat(
  "vB7DR=",
  string(vB7DR,n10),
  ",vB7D=",
...
compute p386="vB7DR=7，vB7D應<=vA7R".
end if.
